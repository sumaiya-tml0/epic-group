...
function BannerText() {
  return (
    <div className=' md:max-w-[800px] mx-auto relative'>
        <div className='px-5 lg:px-0 flex flex-col items-center justify-center text-center text-white absolute -top-68 md:-top-56 space-y-6 z-10'>
...
<button className='capitalize bg-[#284dae] px-6 py-3.5 rounded-4xl cursor-pointer transition duration-300 transform hover:bg-white hover:text-[#284dae] hover:shadow-[0_12px_28px_rgba(0,0,0,0.12)] hover:-translate-y-0.5'>Discover more</button>
        </div>
    </div>
  )
}
